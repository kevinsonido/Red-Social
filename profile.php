...
<!DOCTYPE html>
	<html>
	<head>
		<title>Profile | Facebook GT</title>
	</head>
	...
	<body style="font-family: tahoma; background-color: #d0d8e4;">
 			...
 			<div style="max-width:600px;margin:auto;min-height: 400px;flex:2.5;padding: 20px;padding-right: 0px;">
 					...
 					<form method="post" action="profile.php?change=profile" enctype="multipart/form-data">
	 					<div style="border:solid thin #aaa; padding: 10px;background-color: white;">
	 						...
	 						<input id="post_button" type="submit" style="width:120px;" value="Cambiar">
	 						<br>
		...
		<!--cover area-->
		<div style="width: 910px;margin:auto;min-height: 400px;">
			...
			<div style="background-color: white;text-align: center;color: #405d9b">
				...
				<a href="index.php"><div id="menu_buttons">Noticias</div></a>
				<a href="profile.php?section=about&id=<?php echo $user_data['userid'] ?>"><div id="menu_buttons">Acerca de mí</div></a>
				<a href="profile.php?section=followers&id=<?php echo $user_data['userid'] ?>"><div id="menu_buttons">Seguidores</div></a>
				<a href="profile.php?section=following&id=<?php echo $user_data['userid'] ?>"><div id="menu_buttons">Siguiendo</div></a>
				...
				<?php
					if($user_data['userid'] == $_SESSION['mybook_userid']){
						echo '<a href="profile.php?section=settings&id='.$user_data['userid'].'"><div id="menu_buttons">Ajustes</div></a>';
					}
				?>
			</div>
