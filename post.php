				...
				if(isset($_SESSION['mybook_userid'])){
			 	...
			 	if($ROW['likes'] > 0){
			 		...
			 		if($ROW['likes'] == 1){
			 			...
			 			if($i_liked){
			 				echo "<div style='text-align:left;'>Te gustó esta publicación </div>";
			 			}else{
			 				echo "<div style='text-align:left;'> A 1 persona le gustó esta publicación </div>";
			 			}
			 		}else{
			 			...
			 			if($i_liked){
			 				...
			 				echo "<div style='text-align:left;'> Tú y " . ($ROW['likes'] - 1) . " $text les gustó esta publicación </div>";
			 			}else{
			 				echo "<div style='text-align:left;'>" . $ROW['likes'] . " a otros les gustó esta publicación </div>";
			 			}
			 		}
